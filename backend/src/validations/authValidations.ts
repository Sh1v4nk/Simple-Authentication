import { z } from "zod";
import { RESET_TOKEN_HEX_LENGTH } from "@/constants/security";
...
export const tokenSchema = z.string().length(RESET_TOKEN_HEX_LENGTH, { message: VALIDATION_MESSAGES.RESET_TOKEN_LENGTH });
